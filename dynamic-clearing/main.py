...
def get_args():
    ...
    parser.add_argument('--name', type=str, default='tlc', choices=['tlc', 'synthetic', 'synthetic_lp', 'venmo', 'safegraph', 'ethereum'], help='Dataset to run experiments on (see available choices)')
...
if __name__ == '__main__':
    ...
    for B in B_range:
        for _ in range(args.num_iters):
            ...
            elif args.name == 'ethereum':
                L, b, c, loc2idx, idx2zone = data.load_ethereum_data(args.filename)
